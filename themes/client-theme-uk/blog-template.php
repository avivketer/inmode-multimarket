...
<section class="main_part">
    <div class="container-fluid fixed_width">
        <h2 class="page_title text-center color2 p-3">Blog</h2>
        ...
        <div class="form-filters">
            <form id="filter-form">
                ...
                <input type="hidden" id="post-type" name="post_type" value="post">
        ...
        <div id="posts-container" class="Blog-list row"></div>
    </div>
